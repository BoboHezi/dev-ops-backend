        ...
        try {
            if (dictCode.indexOf(",") != -1) {
                ...
                if (params.length == 4) {
                    ...
                    if (dictCode.equals("devops_sign_platform,platform_sign_product,platform_sign_product") && !request.getRemoteUser().contains("username=admin")) {
                        String username = request.getRemoteUser().split("username=")[1].split(",")[0];
                        ls = sysDictService.queryTableDictItemsByCodeAndUsername(params[0], params[1], params[2], username);
                    } else {
            ...
            //去重
            if (dictCode.equals("devops_code,code_name,code_name") || (dictCode.equals("devops_sign_platform,platform_sign_product,platform_sign_product") && request.getRemoteUser().contains("username=admin"))) {
